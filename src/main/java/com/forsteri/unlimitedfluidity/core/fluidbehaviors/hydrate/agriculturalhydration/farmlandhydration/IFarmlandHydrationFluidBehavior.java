 ...
 * <p>This is a interface for {@link FarmlandHydrationFluidBehavior} for allowance of further extending</p>
 * @since       2.0
 */
@Api
public interface IFarmlandHydrationFluidBehavior extends IFluidBehavior {
    /**
     * @return      whether the implementation allows farmland hydration
     * @since       2.0
     */
    @Api
